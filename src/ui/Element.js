  ...
  return EventHandler.extend(/** @lends ui/Element# */{
    ...
    'addAt': function (element, index) {
      ...
      if (!Utils.isString(element) && !element.getDom) {
        // TODO Error
        false // object-throw 'Child has to be an Element, string or number. (' + element + ')'
      }
    ...
    'addNear': function (element, targetElement, nextToIt) {
      if (targetElement.getParent() !== this) {
        // TODO error
        false // object-throw 'Target element\'s parent and parent which will be added into must be the same element'
        // return
      }
